import type { API, defs } from './type';
...
export namespace APIs {
  ...
  export namespace pet {
     ...
     */
    export const addPet: SDKMethods4<
     ...
     */
    export const updatePet: SDKMethods4<
     ...
     */
    export const uploadFile: SDKMethods3<
  ...
  export namespace store {
     ...
     */
    export const placeOrder: SDKMethods4<
  ...
  export namespace user {
     ...
     * @summary: Create user
     */
    export const createUser: SDKMethods4<
     ...
     */
    export const createUsersWithArrayInput: SDKMethods4<
      API.user.createUsersWithArrayInput.method,
      {},
      API.user.createUsersWithArrayInput.bodyParams,
      API.user.createUsersWithArrayInput.APIResponse
    >;
     ...
     * @summary: Creates list of users with given input array
     */
    export const createUsersWithListInput: SDKMethods4<
